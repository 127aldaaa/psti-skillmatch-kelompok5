...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE profil SET nama_lengkap='$nama', email='$email', nim='$nim', foto_profil='$foto_name' 
            WHERE username='" . $data['username'] . "'";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Berhasil!'); window.location='index_profil.php';</script>";
    }
}
?>
...
<head>
    ...
    <style>
        ...
        .btn-save { background: #28a745; color: white; border: none; padding: 10px; width: 100%; border-radius: 5px; cursor: pointer; font-weight: bold; }
    </style>
</head>
<body>
...
<div class="card">
    <form action="" method="POST" enctype="multipart/form-data">
        <h3 style="text-align:center;">Edit Profil</h3>
        <div class="form-group" style="text-align:center;">
            <img src="../image/<?php echo $data['foto_profil'] ?: 'default.png'; ?>" style="width:70px; height:70px; border-radius:50%; object-fit:cover;">
        ...
        <div class="form-group"><label>Nama</label><input type="text" name="nama_lengkap" value="<?php echo $data['nama_lengkap']; ?>"></div>
