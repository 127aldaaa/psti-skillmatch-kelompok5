            ...
            <div class="flex justify-between items-center text-white">
                ...
                <div class="hidden md:flex space-x-8 items-center text-sm font-medium">
                    ...
                    <div class="flex items-center gap-3 pl-6 border-l border-white/20">
                        ...
                        <a href="../logout.php" class="w-9 h-9 rounded-full bg-red-500 hover:bg-red-600 text-white flex items-center justify-center transition-colors shadow-lg">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 mb-24">
        ...
        <div class="bg-surface rounded-2xl floating-box flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-slate-100 mb-8 border border-slate-200">
            <a href="#" class="flex-1 p-6 flex items-center gap-4 hover:bg-blue-50/50 transition rounded-l-2xl group">
                <div class="w-12 h-12 rounded-full bg-blue-100 text-admin-blue flex items-center justify-center text-xl group-hover:scale-110 transition-transform">
            ...
            <a href="#" class="flex-1 p-6 flex items-center gap-4 hover:bg-blue-50/50 transition group">
                <div class="w-12 h-12 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center text-xl group-hover:scale-110 transition-transform">
            ...
            <a href="../profil%20mahasiswa/index_profil.php" class="flex-1 p-6 flex items-center gap-4 hover:bg-blue-50/50 transition rounded-r-2xl group">
                <div class="w-12 h-12 rounded-full bg-orange-100 text-orange-500 flex items-center justify-center text-xl group-hover:scale-110 transition-transform">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div class="bg-surface rounded-2xl p-6 border border-slate-200 card-shadow flex flex-col relative overflow-hidden">
                ...
                <a href="../profil%20mahasiswa/index_profil.php" class="mt-auto block w-full py-2.5 bg-admin-blue text-white text-center font-bold text-sm rounded-xl hover:bg-admin-dark transition-colors shadow-md">
                ...
                <div class="space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar">
                    <div>
                        <div class="flex justify-between text-sm mb-1.5">
                            <span class="font-semibold text-slate-700"><i class="fa-brands fa-laravel text-red-500 mr-2"></i>Laravel Framework</span>
                            <span class="font-bold text-admin-blue">75%</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
                            <div class="bg-admin-blue h-2 rounded-full" style="width: 75%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm mb-1.5">
                            <span class="font-semibold text-slate-700"><i class="fa-brands fa-html5 text-orange-500 mr-2"></i>Front-End (HTML/CSS)</span>
                            <span class="font-bold text-emerald-500">90%</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
                    ...
                    <div>
                        <div class="flex justify-between text-sm mb-1.5">
                            <span class="font-semibold text-slate-700"><i class="fa-brands fa-figma text-purple-500 mr-2"></i>UI/UX Design</span>
                            <span class="font-bold text-admin-secondary">60%</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
                            <div class="bg-admin-secondary h-2 rounded-full" style="width: 60%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm mb-1.5">
                            <span class="font-semibold text-slate-700"><i class="fa-solid fa-brain text-amber-500 mr-2"></i>Machine Learning</span>
                            <span class="font-bold text-amber-500">30%</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-2">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-surface rounded-2xl p-6 border border-slate-200 card-shadow flex gap-5 items-center hover:border-admin-blue transition-colors group">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 text-admin-blue flex items-center justify-center text-3xl shrink-0 group-hover:scale-105 transition-transform">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Cocok dengan skor logika yang tinggi (88%).</p>
                    </div>
                    <button class="w-10 h-10 rounded-full bg-slate-50 hover:bg-admin-blue hover:text-white text-slate-400 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-arrow-right"></i>
                    </button>
                </div>

                <div class="bg-surface rounded-2xl p-6 border border-slate-200 card-shadow flex gap-5 items-center hover:border-admin-blue transition-colors group">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-100 to-emerald-50 text-emerald-600 flex items-center justify-center text-3xl shrink-0 group-hover:scale-105 transition-transform">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-slate-500 mt-1">Skill lanjutan setelah menguasai framework.</p>
                    </div>
                    <button class="w-10 h-10 rounded-full bg-slate-50 hover:bg-admin-blue hover:text-white text-slate-400 flex items-center justify-center transition-colors">
                        <i class="fa-solid fa-arrow-right"></i>
                    </button>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="bg-surface rounded-2xl border border-slate-200 card-shadow overflow-hidden lg:col-span-2 flex flex-col">
                <div class="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                    <h3 class="text-sm font-bold text-slate-400 uppercase tracking-wider">Kursus & Pelatihan</h3>
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="text-sm">
                            <tr class="hover:bg-slate-50 border-b border-slate-50">
                                <td class="py-3 px-4 font-bold text-slate-800"><i class="fa-brands fa-laravel text-red-500 mr-2 text-lg"></i> MVC in Laravel</td>
                                <td class="py-3 px-4 text-slate-500">Web Dev</td>
                                <td class="py-3 px-4 text-right"><button class="bg-white border border-slate-200 text-admin-blue px-3 py-1.5 rounded-lg text-xs shadow-sm">Enroll</button></td>
                            </tr>
                            <tr class="hover:bg-slate-50 border-b border-slate-50">
                                <td class="py-3 px-4 font-bold text-slate-800"><i class="fa-solid fa-wand-magic-sparkles text-purple-500 mr-2 text-lg"></i> UI Design</td>
            ...
            <div class="bg-surface rounded-2xl p-6 border border-slate-200 card-shadow flex flex-col">
                ...
                <div class="space-y-4 flex-1">
                    <div class="flex gap-3">
                        <div class="w-10 h-10 rounded-full bg-blue-50 text-admin-blue flex items-center justify-center shrink-0 border border-blue-100"><i class="fa-solid fa-bullhorn"></i></div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-800">Jadwal Mentoring</h4>
                            <p class="text-xs text-slate-500">Pertemuan dijadwalkan ulang besok siang.</p>
                        </div>
                    </div>
                    <div class="flex gap-3">
                        <div class="w-10 h-10 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 border border-emerald-100"><i class="fa-solid fa-check-double"></i></div>
                        <div>
                            <h4 class="text-sm font-bold text-slate-800">Sertifikat Tersedia</h4>
                            <p class="text-xs text-slate-500">Sertifikat kursus HTML/CSS sudah bisa diunduh.</p>
                        </div>
                    </div>
                </div>
                <button class="w-full mt-4 py-2 bg-slate-50 text-admin-dark font-bold text-xs rounded-lg border border-slate-200">Lihat Semua</button>
            </div>
        </div>
        ...
        <div class="mt-8 bg-surface rounded-2xl p-6 border border-slate-200 card-shadow">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <button class="px-3 py-1.5 border border-dashed border-slate-300 rounded-lg text-sm font-bold text-slate-400 hover:border-admin-blue transition-colors flex items-center gap-2"><i class="fa-solid fa-plus"></i> Tambah Log</button>
            </div>
        </div>
